// Copied from extern/dolphin/include/dolphin/axfx.h
//
// Aurora has no AXFX equivalent at all
// Including axfx caused other dolphin headers to be pulled in, so let's just
// vendor it
